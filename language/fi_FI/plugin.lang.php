...
$lang['Trust'] = 'Luottamus';
$lang['Validate or reject pending photos'] = 'Hyväksy tai hylkää odottavia kuvia';
$lang['You need to confirm deletion'] = 'Sinun on vahvistettava poisto';
$lang[' (already owns album "%s")'] = '(omistaa jo albumin "%s")';
$lang[' (owns this album)'] = '(omistaa tämän albumin)';
$lang['No photo selected, no action possible.'] = 'Ei kuvaa valittuna, mikään toiminto ei ole mahdollinen.';
$lang['Photos posted by %s'] = '%s:n lähettämät kuvat';
$lang['Photos posted by %s in album %s'] = '%s:n lähettämät kuvat albumissa %s';
$lang['Select at least one photo'] = 'Valitse ainakin yksi kuva';
$lang['No photo can be deleted'] = 'Yhtään kuvaa ei voi poistaa';
$lang['Drag files here.'] = 'Raahaa tiedostot tähän.';
$lang['Edit Photos'] = 'Muokkaa kuvia';
$lang['Edit photos'] = 'Muokkaa kuvia';
$lang['Edit your photos'] = 'Muokkaa kuviasi';
